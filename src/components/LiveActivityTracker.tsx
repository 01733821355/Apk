          ...
          <div className="grid grid-cols-1 sm:grid-cols-4 gap-3">
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                ...
                <VoiceInputButton
                  inputType="number"
                  contextLabel="স্টেপ সংখ্যা"
                  onTranscript={(val) => setHealthSteps(val)}
                  size="xs"
                />
              </div>
              <div className="relative">
                <input
                  ...
                  placeholder="5000"
                  className="w-full pl-3 pr-16 py-2 rounded-xl bg-slate-50 border border-slate-200 text-xs font-bold text-slate-800 focus:ring-2 focus:ring-blue-500 focus:outline-hidden"
                />
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                ...
                <VoiceInputButton
                  inputType="number"
                  contextLabel="মিনিট"
                  onTranscript={(val) => setHealthDuration(val)}
                  size="xs"
                />
              </div>
              <div className="relative">
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                ...
                <VoiceInputButton
                  inputType="number"
                  contextLabel="হার্ট রেট"
                  onTranscript={(val) => setHealthHeartRate(val)}
                  size="xs"
                />
              </div>
              <div className="relative">
