          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div>
              <div className="flex items-center justify-between mb-1">
                ...
                <VoiceInputButton
                  inputType="date"
                  contextLabel="শুরু তারিখ"
                  onTranscript={(val) => setStartDate(val)}
                  size="xs"
                />
              </div>
              <div className="relative">
                <input
                  ...
                  className="w-full bg-white border border-slate-200 rounded-xl px-3 pr-9 py-2 text-xs text-slate-700 font-medium focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500"
                />
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                ...
                <VoiceInputButton
                  inputType="date"
                  contextLabel="শেষ তারিখ"
                  onTranscript={(val) => setEndDate(val)}
                  size="xs"
                />
              </div>
              <div className="relative">
