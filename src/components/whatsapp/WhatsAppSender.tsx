            ...
            <div className="space-y-4 text-xs">
              <div className="space-y-1">
                <div className="flex items-center justify-between">
                  ...
                  <VoiceInputButton
                    inputType="text"
                    contextLabel="ক্যাটাগরি নাম"
                    onTranscript={(val) => setPresetFormNameBn(val)}
                    size="xs"
                  />
                </div>
                <div className="relative">
                  <input 
                    ...
                    className="w-full p-3 pr-10 border rounded-xl dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-white text-sm outline-none focus:ring-2 focus:ring-purple-500" 
                  />
              ...
              <div className="space-y-1">
                <div className="flex items-center justify-between">
                  ...
                  <VoiceInputButton
                    inputType="text"
                    contextLabel="ইংরেজি ক্যাটাগরি নাম"
                    onTranscript={(val) => setPresetFormNameEn(val)}
                    size="xs"
                  />
                </div>
                <div className="relative">
              ...
              <div className="space-y-1">
                <div className="flex items-center justify-between">
                  ...
                  <VoiceInputButton
                    inputType="textarea"
                    contextLabel="আইটেম তালিকা"
                    currentValue={presetFormItemsBn}
                    appendMode={true}
                    onTranscript={(val) => setPresetFormItemsBn(prev => prev ? `${prev}\n${val}` : val)}
                    size="xs"
                  />
                </div>
                <div className="relative">
              ...
              <div className="space-y-1">
                <div className="flex items-center justify-between">
                  ...
                  <VoiceInputButton
                    inputType="textarea"
                    contextLabel="ইংরেজি আইটেম তালিকা"
                    currentValue={presetFormItemsEn}
                    appendMode={true}
                    onTranscript={(val) => setPresetFormItemsEn(prev => prev ? `${prev}\n${val}` : val)}
                    size="xs"
                  />
                </div>
                <div className="relative">
