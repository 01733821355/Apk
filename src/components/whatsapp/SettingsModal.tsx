            ...
            <div className="space-y-3 text-xs">
              <div>
                <div className="flex items-center justify-between mb-1">
                  <label className="font-semibold block opacity-70">
                    {isBn ? 'হেডার (বাংলা) — _____ দিয়ে ক্যাটাগরি নাম বোঝাবে' : 'Header (Bangla) — _____ is category placeholder'}
                  </label>
                  <VoiceInputButton
                    inputType="text"
                    contextLabel="বাংলা হেডার"
                    onTranscript={(val) => updateSettings({ headerBn: val })}
                    size="xs"
                  />
                </div>
                <div className="relative">
                  <input 
                    ...
                    className="w-full p-2.5 pr-9 rounded-xl border dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-white"
                  />
              ...
              <div>
                <div className="flex items-center justify-between mb-1">
                  ...
                  <VoiceInputButton
                    inputType="textarea"
                    contextLabel="বাংলা ফুটার"
                    onTranscript={(val) => updateSettings({ footerBn: val })}
                    size="xs"
                  />
                </div>
                <div className="relative">
              ...
              <div>
                <div className="flex items-center justify-between mb-1">
                  ...
                  <VoiceInputButton
                    inputType="text"
                    contextLabel="ইংরেজি হেডার"
                    onTranscript={(val) => updateSettings({ headerEn: val })}
                    size="xs"
                  />
                </div>
                <div className="relative">
              ...
              <div>
                <div className="flex items-center justify-between mb-1">
                  ...
                  <VoiceInputButton
                    inputType="textarea"
                    contextLabel="ইংরেজি ফুটার"
                    onTranscript={(val) => updateSettings({ footerEn: val })}
                    size="xs"
                  />
                </div>
                <div className="relative">
