          ...
          <div className="flex gap-2 w-full md:w-auto items-center">
            <div className="relative flex-1 md:w-64">
              <input 
                ...
                className={`w-full border rounded-xl p-2.5 pl-4 pr-10 text-sm outline-none focus:ring-2 focus:ring-purple-500 ${
              ...
              <div className="absolute right-2 top-1/2 -translate-y-1/2">
                <VoiceInputButton
                  inputType="search"
                  contextLabel="মেসেজ খুঁজুন"
                  onTranscript={(val) => setSearchTerm(val)}
                  size="xs"
                />
              </div>
            </div>
