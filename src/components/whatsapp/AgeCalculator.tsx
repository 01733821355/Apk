        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <VoiceInputButton
                inputType="date"
                contextLabel="জন্ম তারিখ"
                onTranscript={(val) => setDob(val)}
                size="xs"
              />
            </div>
            <div className="relative">
              <input 
                ...
                className={`w-full rounded-2xl p-3.5 sm:p-4 pr-12 focus:ring-2 focus:ring-indigo-400 text-base sm:text-lg border ${isDark ? 'bg-slate-900 border-slate-700 text-white' : 'bg-slate-50 border-slate-200 text-slate-900'}`}
              />
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <VoiceInputButton
                inputType="date"
                contextLabel="লক্ষ্য তারিখ"
                onTranscript={(val) => setTargetDate(val)}
                size="xs"
              />
            </div>
            <div className="relative">
