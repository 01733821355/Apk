          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                ...
                <VoiceInputButton
                  inputType="date"
                  contextLabel="লেনদেনের তারিখ"
                  onTranscript={(val) => setDate(val)}
                  size="xs"
                />
              </div>
              <div className="relative">
          ...
          {isLoanOrDharCategory && (
            <div className="bg-amber-50/60 border border-amber-200 rounded-xl p-3 animate-in fade-in-50">
              <div className="flex items-center justify-between mb-1">
                ...
                <VoiceInputButton
                  inputType="text"
                  contextLabel="ব্যক্তির নাম"
                  onTranscript={(val) => setPersonName(val)}
                  size="xs"
                />
              </div>
              <div className="relative">
                <input
                  ...
                  className="w-full pl-3 pr-10 py-1.5 text-xs bg-white border border-amber-300 rounded-lg focus:ring-2 focus:ring-amber-500/20"
                />
                <div className="absolute right-1.5 top-1/2 -translate-y-1/2">
                  <VoiceInputButton
                    inputType="text"
                    contextLabel="ঋণদাতার নাম"
                    onTranscript={(val) => setPersonName(val)}
                    size="xs"
                  />
                </div>
