          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            {onOpenAndroidAppModal && (
              <button
                ...
                className="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-xs font-semibold bg-emerald-50 border border-emerald-200 text-emerald-700 hover:bg-emerald-100 transition-colors shadow-xs"
                title={language === 'bn' ? 'অ্যান্ড্রয়েড অ্যাপ ও APK' : 'Android App & APK'}
              >
                <Smartphone className="w-3.5 h-3.5 text-emerald-600" />
                <span className="hidden sm:inline">{language === 'bn' ? 'মোবাইল অ্যাপ' : 'Mobile App'}</span>
              </button>
            )}
                ...
                <div className="absolute right-0 mt-2 w-64 rounded-2xl bg-white border border-slate-200 shadow-2xl p-3 z-50 animate-in fade-in slide-in-from-top-2 duration-150">
                  ...
                  {onOpenAndroidAppModal && (
                    <button
                      ...
                      className="w-full text-left flex items-center gap-2 px-2.5 py-2 text-xs text-emerald-700 hover:bg-emerald-50 rounded-xl transition-colors font-medium"
                    >
                      <Smartphone className="w-4 h-4 text-emerald-600" />
                      <span>{language === 'bn' ? 'অ্যান্ড্রয়েড অ্যাপ ও APK' : 'Android App & APK'}</span>
                    </button>
                  )}
